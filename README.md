...
分享方向：**自学教程、面试真题解析、面试经验分享、技术专题深度解析**。
...
文章首发于[【公众号】](#公众号)，CSDN和知乎也会及时更新，文章涉及的相关资料都会整理在Github上，有问题或者有建议，欢迎在我的[【公众号】](#公众号)留言，看到后第一时间回复。
...
# 学习交流群
为了方便大家学习交流，我建了一个 Java 学习交流群，交流群仅用于 Java 学习交流、畅谈人生、闲聊扯淡，大家可以在里面和其他同学交流，里面有很多热心的同学帮助大家解决疑问，各种广告大哥们请手下留情。

有兴趣加入的请加我微信（下方二维码），进 Java 学习交流群，备注：加群。  
...
## 面试经验分享
- [921天，从小厂到入职阿里](https://blog.csdn.net/v123411739/article/details/106182747)
...
- [5 年 Java 经验，字节、美团、快手核心部门面试总结（真题解析）](https://mp.weixin.qq.com/s/B2EfACYPkVAvxsHyWomeAg)
...
## Java 基础
- [Java 基础高频面试题（2021年最新版）](https://mp.weixin.qq.com/s/s6ZhOvyLmPvdQ8snvt9H_Q)
...
## 集合（HashMap）
- [Java 集合高频面试题（带解析）](https://blog.csdn.net/v123411739/article/details/115712641)
...
## Redis
- [缓存穿透、缓存击穿、缓存雪崩解决方案](https://mp.weixin.qq.com/s/QX8UviH7iaxXTz-Io_7uZg)
- [面试必问的缓存使用：如何保证数据一致性、缓存设计模式](https://mp.weixin.qq.com/s/P3w13_s9Pngj-GW57AnV4g)
- [面试必问的 Redis：Memcached VS Redis](https://mp.weixin.qq.com/s/oPpjGP6jjfiZwjdbTuVzNg)
- [深入剖析 Redis 高可用解决方案：哨兵、集群](https://mp.weixin.qq.com/s/_rxkA9AXlnkSU-l191GgrQ)
- [面试必问的 Redis：主从复制](https://mp.weixin.qq.com/s/HVj4LXsI1_sfTNQyjf_9lg)
...
## 分布式
- [面试必问的分布式锁，你懂了吗？](https://mp.weixin.qq.com/s/1XP_GmZ58B4CspdaTHJGJA)
